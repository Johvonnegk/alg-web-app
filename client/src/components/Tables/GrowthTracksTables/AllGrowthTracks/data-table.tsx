        ...
        <div className="w-full flex justify-between">
          <div>
            <Input
              ...
              className="max-w-sm border-stone-300"
            />
          </div>
          <div className="flex gap-x-2">
            <Select
              onValueChange={(value) =>
                table.getColumn("coursePass")?.setFilterValue(value)
              }
            >
              <SelectTrigger className="w-auto border-stone-300">
                <SelectValue placeholder="Filter by class passed" />
              </SelectTrigger>
              <SelectContent className="bg-white border-stone-300">
                <SelectItem value="all">All Classes</SelectItem>
                <SelectItem value="101">Passed 101</SelectItem>
                <SelectItem value="201">Passed 201</SelectItem>
                <SelectItem value="301">Passed 301</SelectItem>
                <SelectItem value="401">Passed 401</SelectItem>
              </SelectContent>
            </Select>
            <Select
              onValueChange={(value) =>
                table.getColumn("graduated")?.setFilterValue(value)
              }
            >
              <SelectTrigger className="w-auto border-stone-300">
                <SelectValue placeholder="Filter Graduated" />
              </SelectTrigger>
              <SelectContent className="bg-white border-stone-300">
